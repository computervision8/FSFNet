...
class cityscapes(Dataset):
    def __init__(self, root, co_transform=None, subset='train'):
        self.images_root = os.path.join(root, 'leftImg8bit_trainvaltest/leftImg8bit/')
...
class camvid(Dataset):
    def __init__(self, root, co_transform=None, subset='train'):
        # camvid
        self.images_root = os.path.join(root, 'images/')
        self.labels_root = os.path.join(root, 'images/label/')
        ...
        self.filenamesGt = [os.path.join(dp, f) for dp, dn, fn in os.walk(os.path.expanduser(self.labels_root)) for
                            f in
                            fn if is_label_camvid(f)]
        self.filenamesGt.sort()
...
class mapillary(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(10):
            ...
            j+=1
        index_temp = max
        index_temp2 = filename[index_temp:]
        index_temp2= index_temp2.split('.jpg')
        index_temp3= index_temp2[0]
        index_temp4= self.labels_root + index_temp3 + '.png'

        filenameGt =index_temp4
