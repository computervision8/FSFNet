...
def main(args):
    ...
    print('args.datadir :', args.subset)
    ...
    for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        #filenameSave = "./save_results/" + filename[0].split("leftImg8bit_trainvaltest/leftImg8bit/")[1]
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--loadDir', default="/home/etri/CODE/FSFNet/save/FSFNet_onlyC(save)/")
    parser.add_argument('--loadDir', default="/home/etri/CODE/FSFNet/save/FSFNet_imagenet(save)/")
