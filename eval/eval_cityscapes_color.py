...
if __name__ == '__main__':
    ...
    parser.add_argument('--loadWeights', default="model_best.pth") # ERINET
    ...
    # Cityscapes dataset
    parser.add_argument('--datadir', default="/home/etri/DB/CITYSCAPES_DATASET")

    # Real-world sample image
    # parser.add_argument('--datadir', default="../realworld_sample_images/1/")
